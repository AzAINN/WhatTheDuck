...
witness_top_n = np.max(errors * np.sqrt(num_samples_list))
witness_bottom_n = np.min(errors * np.sqrt(num_samples_list))
...
witness_top_e2 = np.max(num_samples_array / inv_error_sq)
witness_bottom_e2 = np.min(num_samples_array / inv_error_sq)
