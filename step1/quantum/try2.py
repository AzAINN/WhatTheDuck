...
ax2.plot(grover_calls_fig2, epsilons_fig2,
         marker='o', markersize=4, linewidth=2,
         color=COLOR_QUANTUM, alpha=0.8,
         label='Target Precision (ε)', zorder=4)
...
style_axes(ax3,
          ...
          r'Inverse Squared Precision ($\varepsilon^{-2}$)',
...
ax_c.plot(grover_calls_fig2, epsilons_fig2, marker='o', markersize=3,
...
ax_c.set_ylabel('Target Precision (ε)', fontweight='500', color=COLOR_TEXT, fontsize=10)
